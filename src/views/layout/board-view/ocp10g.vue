    ...
    <div class="board-table-container">
      <table class="board-table" border="1">
        ...
        <tr>
          ...
          <td>
            <Limit :min="-10" :max="-18" v-if="infoData.channels[0].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[0].rcv_thr_L.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-10" :max="-18" v-if="infoData.channels[0].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[0].rcv_thr_L.Sec_Line" />
            <template v-else>NA</template>
          </td>
          <td>
          ...
          <td>
            <Limit :min="-10" :max="-18" v-if="infoData.channels[1].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[1].rcv_thr_L.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-10" :max="-18" v-if="infoData.channels[1].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[1].rcv_thr_L.Sec_Line" />
            <template v-else>NA</template>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Limit :min="-1" :max="3" v-if="infoData.channels[0].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[0].rcv_thr_H.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-1" :max="3" v-if="infoData.channels[0].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[0].rcv_thr_H.Sec_Line" />
            <template v-else>NA</template>
          </td>
          <td>
          ...
          <td>
            <Limit :min="-1" :max="3" v-if="infoData.channels[1].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[1].rcv_thr_H.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-1" :max="3" v-if="infoData.channels[1].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[1].rcv_thr_H.Sec_Line" />
            <template v-else>NA</template>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Limit :min="-5" :max="-8" v-if="infoData.channels[0].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[0].tx_thr_L.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-5" :max="-8" v-if="infoData.channels[0].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[0].tx_thr_L.Sec_Line" />
            <template v-else>NA</template>
          </td>
          <td>
          ...
          <td>
            <Limit :min="-5" :max="-8" v-if="infoData.channels[1].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[1].tx_thr_L.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="-5" :max="-8" v-if="infoData.channels[1].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[1].tx_thr_L.Sec_Line" />
            <template v-else>NA</template>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <Limit :min="0" :max="5" v-if="infoData.channels[0].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[0].tx_thr_H.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="0" :max="5" v-if="infoData.channels[0].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[0].tx_thr_H.Sec_Line" />
            <template v-else>NA</template>
          </td>
          <td>
          ...
          <td>
            <Limit :min="0" :max="5" v-if="infoData.channels[1].link_status.Pri_Line" type="text" class="def-input" v-model="infoData.channels[1].tx_thr_H.Pri_Line" />
            <template v-else>NA</template>
          </td>
          <td>
            <Limit :min="0" :max="5" v-if="infoData.channels[1].link_status.Sec_Line" type="text" class="def-input" v-model="infoData.channels[1].tx_thr_H.Sec_Line" />
            <template v-else>NA</template>
          </td>
        </tr>
      </table>
