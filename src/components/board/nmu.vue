<template>
  <div class="board-nmu-view-wrapper board-item-view-wrapper">
    ...
    <div class="board-link-wrapper nmu-link-wrapper">
      <div class="board-light"><span class="k-name">PWR</span><span class="k-item suc"></span><span class="k-item" :class="light[4] ? 'war' : 'suc'"></span><span class="k-name">OLINK1</span></div>
      <div class="board-light"><span class="k-name">RUN</span><span class="k-item run-los"></span><span class="k-item" :class="light[5] ? 'war' : 'suc'"></span><span class="k-name">OLINK2</span></div>
      <div class="board-light">
        <span class="k-name">PROG</span><span class="k-item" :class="light[2] ? 'war' : 'suc'"></span><span class="k-item" :class="light[6] ? 'war' : 'suc'"></span><span class="k-name">OLINK3</span>
      </div>
      <div class="board-light">
        <span class="k-name">STAT</span><span class="k-item" :class="light[3] ? 'war' : 'suc'"></span><span class="k-item" :class="light[7] ? 'war' : 'suc'"></span><span class="k-name">BLINK</span>
      </div>
    </div>
