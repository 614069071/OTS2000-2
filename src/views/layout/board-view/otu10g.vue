      ...
      <table class="board-table" border="1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="coll-2">
                <select v-if="info.bdtype === '10G-OTUL'" v-model="infoData.channels[0].speed">
                ...
                <select v-else-if="info.bdtype === '10G-OTUH'" v-model="infoData.channels[0].speed">
            ...
            <td>
              <div class="coll-2">
                <select v-if="info.bdtype === '10G-OTUL'" v-model="infoData.channels[1].speed">
                  <option :value="1">FC(包含2G、4G、8G、10G)</option>
                  <option :value="2">CPRIX(X值为3，5，6，7)</option>
                  <option :value="3">CPRIX(X值为3，5，7，8)</option>
                  <option :value="4">OTU1/OTU1e</option>
                ...
                <select v-else-if="info.bdtype === '10G-OTUH'" v-model="infoData.channels[1].speed">
                  <option :value="1">10G FC</option>
                  <option :value="2">CPRI2/3/4/5/6/7</option>
                  <option :value="3">CPRI2/3/5/7/8</option>
                  <option :value="4">OTU1/OTU1e</option>
            ...
            <td>
              <div class="coll-2">
                <select v-if="info.bdtype === '10G-OTUL'" v-model="infoData.channels[2].speed">
                  <option :value="1">FC(包含2G、4G、8G、10G)</option>
                  <option :value="2">CPRIX(X值为3，5，6，7)</option>
                  <option :value="3">CPRIX(X值为3，5，7，8)</option>
                  <option :value="4">OTU1/OTU1e</option>
                ...
                <select v-else-if="info.bdtype === '10G-OTUH'" v-model="infoData.channels[2].speed">
                  <option :value="1">10G FC</option>
                  <option :value="2">CPRI2/3/4/5/6/7</option>
                  <option :value="3">CPRI2/3/5/7/8</option>
                  <option :value="4">OTU1/OTU1e</option>
            ...
            <td>
              <div class="coll-2">
                <select v-if="info.bdtype === '10G-OTUL'" v-model="infoData.channels[3].speed">
                  <option :value="1">FC(包含2G、4G、8G、10G)</option>
                  <option :value="2">CPRIX(X值为3，5，6，7)</option>
                  <option :value="3">CPRIX(X值为3，5，7，8)</option>
                  <option :value="4">OTU1/OTU1e</option>
                ...
                <select v-else-if="info.bdtype === '10G-OTUH'" v-model="infoData.channels[3].speed">
                  <option :value="1">10G FC</option>
                  <option :value="2">CPRI2/3/4/5/6/7</option>
                  <option :value="3">CPRI2/3/5/7/8</option>
                  <option :value="4">OTU1/OTU1e</option>
          ...
          <tr>
            ...
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[0].link_status.client" v-model="infoData.channels[0].rcv_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[0].link_status.line" v-model="infoData.channels[0].rcv_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[1].link_status.client" v-model="infoData.channels[1].rcv_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[1].link_status.line" v-model="infoData.channels[1].rcv_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[2].link_status.client" v-model="infoData.channels[2].rcv_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[2].link_status.line" v-model="infoData.channels[2].rcv_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[3].link_status.client" v-model="infoData.channels[3].rcv_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-1" :max="3" v-if="infoData.channels[3].link_status.line" v-model="infoData.channels[3].rcv_thr_H.line" />
              <template v-else>NA</template>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[0].link_status.client" v-model="infoData.channels[0].tx_thr_L.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[0].link_status.line" v-model="infoData.channels[0].tx_thr_L.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[1].link_status.client" v-model="infoData.channels[1].tx_thr_L.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[1].link_status.line" v-model="infoData.channels[1].tx_thr_L.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[2].link_status.client" v-model="infoData.channels[2].tx_thr_L.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[2].link_status.line" v-model="infoData.channels[2].tx_thr_L.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[3].link_status.client" v-model="infoData.channels[3].tx_thr_L.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="-5" :max="-8" v-if="infoData.channels[3].link_status.line" v-model="infoData.channels[3].tx_thr_L.line" />
              <template v-else>NA</template>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[0].link_status.client" v-model="infoData.channels[0].tx_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[0].link_status.line" v-model="infoData.channels[0].tx_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[1].link_status.client" v-model="infoData.channels[1].tx_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[1].link_status.line" v-model="infoData.channels[1].tx_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[2].link_status.client" v-model="infoData.channels[2].tx_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[2].link_status.line" v-model="infoData.channels[2].tx_thr_H.line" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[3].link_status.client" v-model="infoData.channels[3].tx_thr_H.client" />
              <template v-else>NA</template>
            </td>
            <td>
              <Limit :min="0" :max="5" v-if="infoData.channels[3].link_status.line" v-model="infoData.channels[3].tx_thr_H.line"></Limit>
